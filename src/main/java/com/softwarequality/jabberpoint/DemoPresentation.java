...
class DemoPresentation extends Accessor {
  ...
  public void loadFile(Presentation presentation, String unusedFilename) {
    ValidationUtils.checkNotNull(presentation, "Missing presentation in demo");
    ValidationUtils.checkNotNull(unusedFilename, "Missing filename in demo");
  ...
  public void saveFile(Presentation presentation, String unusedFilename) {
    ...
    ValidationUtils.checkNotNull(unusedFilename, "Missing file name to save");
